//Random -> funcion que genera numeros aleatorios
...
let obtnerpistadisntacia = distancia => {//Utilizacion de if anidados para verificar en cual altura da click el usuario
    if (distancia < 30) {
